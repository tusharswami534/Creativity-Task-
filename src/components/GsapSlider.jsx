    ...
    <div ref={componentRef} className="overflow-hidden  bg-gray-200 mx-auto">
     ...
     <div className="min-h-screen flex justify-center items-center bg-gray-200">
      ...
      <div className="this-section min-h-screen flex bg-gray-200 relative overflow-hidden ">
        ...
        <div className="card card-two w-80 h-[500px] z-40 backdrop-blur-sm bg-transparent absolute flex justify-center items-center translate-y-[-50%] top-[-20%] left-[-20%]">
          <img className="backdrop-shadow" src="./assets/image/png/controller-2.png" alt="controller" />
        </div>
        <div className="card card-three w-80 h-[500px] backdrop-blur-sm bg-transparent absolute flex justify-center items-center translate-y-[-50%] top-[-20%] left-[-20%]">
          <img className="backdrop-shadow" src="./assets/image/png/controller-3.png" alt="" />
        </div>
        <div className="card card-four w-80 h-[500px] backdrop-blur-sm bg-transparent absolute flex justify-center items-center translate-y-[-50%] top-[-20%] left-[-20%]">
